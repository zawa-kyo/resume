...
| Item                                                                                                                                                                                                                                                           | Detail                                                                                                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![JavaScript](https://img.shields.io/badge/-JavaScript-E6D211.svg?logo=javascript&style=flat)<br>![HTML5](https://img.shields.io/badge/-HTML5-F5932B.svg?logo=html5&style=flat)<br>![CSS3](https://img.shields.io/badge/-CSS3-1572B6.svg?logo=css3&style=flat) | Cordova, Vue.jsを用いたハイブリッドアプリ開発におけるWebアプリ層に利用 (4年以上)<br>テスティングフレームワーク、アサーションライブラリとして [Jest](https://github.com/jestjs/jest), [Chai](https://github.com/chaijs/chai), [Sinon.JS](https://github.com/sinonjs/) を利用 (2年以上)                                                                                     |
