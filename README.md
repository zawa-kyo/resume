...
- プロジェクトスケジュール、タスク、リソースの計画立案および管理など、スマートフォンアプリケーション開発チームのプロジェクトマネジメント
...
| アジャイル開発         | <ul><li>スクラムチームでの開発経験 (2年以上)</li><li>プロダクトオーナー担当経験 (半年)</li></ul> |
