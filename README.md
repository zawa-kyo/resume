...
- チームの再編成によりスマートフォンアプリケーション開発チームのマネージャー業務、スクラム開発におけるプロダクトオーナー業務を担当。ステークホルダー、社内企画部、テストベンダーなど関係各所との調整を主導した
