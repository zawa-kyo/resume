...
| ![Java](https://img.shields.io/badge/-Java-E21423.svg?logo=openjdk&style=flat)<br>![Swift](https://img.shields.io/badge/-Swift-F4F4F4.svg?logo=swift&style=flat)<br>![Objective-C](https://img.shields.io/badge/-Objective--C-000000.svg?logo=c&style=flat)    | Cordovaを用いたハイブリッドアプリ開発におけるiOS/Androidのネイティブ機能にアクセスするプラグイン開発に利用<br>特にJavaはベンダー資格の取得を通じてモダンな文法、開発手法にも精通している                                                                                                                                                                                 |
...
| ![C](https://img.shields.io/badge/-C-005697.svg?logo=c&style=flat)                                                                                                                                                                                             | 組込みソフトウェア開発に利用 (半年)<br>プロダクションコードを書いたことはなく、簡単な設計とデバッグを経験した程度                                                                                                                                                                                                                                                        |
...
| ![R](https://img.shields.io/badge/-R-276DC3.svg?logo=r&style=flat)                                                                                                                           | 大学院時代に実験データの解析に利用 (2年)<ul><li>実験計画策定のための数値計算</li><li>実験データのプロット</li><li>特異値分解、交互最小二乗法、非負値行列因子分解を用いたスペクトルデータ解析</li></ul> |
