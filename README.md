...
| ![Flutter](https://img.shields.io/badge/-Flutter-1EB6F5.svg?logo=flutter&style=flat)                                                                                            | モバイルアプリ開発の立ち上げを一部経験 (半年)<br>UI開発、サーバ通信、iOS/Android端末におけるネイティブ機能へのアクセスなどを設計からコーディングまで担当                                                                                                 |
